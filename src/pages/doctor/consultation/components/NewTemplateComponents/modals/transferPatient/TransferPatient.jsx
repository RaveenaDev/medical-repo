...
const TransferPatient = ({
  ...
  const departments = useSelector((s) => s.doctor?.allDepartments) || [];

  const doctorsByDept = useSelector((s) => s.doctor?.doctorsByDepartment) || [];
  ...
  const handleSubmit = async () => {
    const payload = {
      ...modalData,
      transferToDoctor: transfer.doctorId,
      department: transfer.departmentId,
      transferNote: transfer.note?.trim() || "",
    ...
    try {
      ...
      await dispatch(submitConsultation(payload, onSuccess, onClose));
      setConfirmedSections?.([]);
  ...
  const selectedDeptName =
    departments.find((d) => d.departmentId === transfer.departmentId)
      ?.departmentName || "";
      ...
      <div className={styles.container}>
        ...
        <div className={styles.section1}>
          <div className={styles.treatmentType}>
            ...
            <div className={styles.dropdown}>
              ...
              >
                <p
                  className={!selectedDeptName ? styles.placeholder : undefined}
                >
          ...
          <div className={styles.treatmentType}>
            ...
            <div className={styles.dropdown}>
              ...
              >
                <p
                  className={
                    !selectedDoctorName ? styles.placeholder : undefined
                  }
                >
                  {selectedDoctorName ||
                ...
                <ul className={styles.menu1}>
                  {doctorsByDept.map((doc) => (
                    <li
                      key={doc._id}
                      className={`${styles.item} ${
                        transfer.doctorId === doc._id ? styles.active : ""
                      }`}
                      onClick={() => {
                        setTransfer((p) => ({
                          ...p,
        ...
        <div className={styles.submitContainer}>
          <button
            ...
            disabled={
              isSubmitting || !transfer.departmentId || !transfer.doctorId
            }
