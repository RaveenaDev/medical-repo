                        ...
                        <div className={styles.parentContainer}>
                            <div className={styles.container2}>
                                ...
                                <div className={styles.regenerate}>
                                    <button className={styles.regenerateButton} onClick={handleRegenerate}>Regenerate
                                    </button>
                                </div>

                                <div className={styles.row4}>
                                    <p className={styles.value}><span
                                        className={styles.key}>Problem Statement:</span>{" "}
                                        ...
                                        <div>
                                            {generatedPrescriptions?.aiGeneratedText?.medications?.map((med, i) => (
                                                <div key={i}
                                                    ...
                                                    <span style={{marginRight: 10}}>&#8226;</span><p
                                                    style={{margin: 0}}>{med}</p>
                                                </div>
                                            ))}
                                        </div>
                                ...
                                <div className={styles.instruct1}>
                                    ...
                                    <div className={styles.row11}>
                                        <div>
                                            <p>
                                                <span>&#8226; </span>&nbsp; Review: {generatedPrescriptions?.aiGeneratedText?.followUpInstructions?.reviewDate || "Not specified"}
                                            </p>
                                            <p>
                                                <span>&#8226; </span>&nbsp; Notes: {generatedPrescriptions?.aiGeneratedText?.followUpInstructions?.notes || "Not specified"}
                                            </p>
                                        </div>
                                ...
                                <div className={styles.search}>
                                    <div className={styles.searchSection}>
                                        ...
                                        <svg style={{marginLeft: '1rem'}} width="35" height="35" viewBox="0 0 40 40"
                                    ...
                                    {isListening ? (
                                        <button className={`${styles.btn} ${styles.micBtn}`} onClick={toggleMic}>Stop
                                            Mic</button>
                                    ) : (
                                        <div style={{cursor: 'pointer', padding: 0, marginTop: 1, height: '2rem'}}
                                             onClick={toggleMic}>
                                            <svg width="50" height="40" viewBox="0 0 60 56" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect y="0.199219" width="60" height="55.6077" rx="27.8038"
                                                      fill="#25307F"/>
                                                <path
                            ...
                            <div className={styles.selectedBlock}>
                                ...
                                <div className={styles.selectedSection}>
                                    <div className={styles.sectionHeader}>
                                        <h4>Medications</h4>
                                        <button className={styles.addBtn} onClick={() => openMedModal("add")}>+ Add
                                            Medicine
                                        </button>
                                    </div>

                                    {selected.medications.length === 0 &&
                                        <div className={styles.emptyNote}>No medicines selected.</div>}
                          ...
                          />
                                                        <div className={styles.rowActions}>
                                                            <button className={styles.saveBtn}
                                                                    onClick={saveAiMedEdit}>Save
                                                            </button>
                                                            <button className={styles.cancelBtn}
                                                                    onClick={cancelAiMedEdit}>Cancel
                                                            </button>
                                                        </div>
                                                    </div>
                                                ) : (
                                                ...
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.editBtn}
                                                                onClick={() => openMedModal("edit", i)}>Edit
                                                        </button>
                                                        <button className={styles.removeBtn}
                                                                onClick={() => removeFromArray("medications", i)}>✕
                                                        </button>
                                ...
                                <div className={styles.selectedSection}>
                                    <div className={styles.sectionHeader}>
                                        ...
                                        {!showAdd.inj ? (
                                            <button className={styles.addBtn} onClick={() => openAdd("inj")}>+
                                                Add</button>
                                        ) : (
                                            <div className={styles.addInlineWrap}>
                                                ...
                                                <div className={styles.rowActions}>
                                                    <button className={styles.saveBtn}
                                                            onClick={() => saveAdd("inj")}>Save
                                                    </button>
                                                    <button className={styles.cancelBtn}
                                                            onClick={() => cancelAdd("inj")}>Cancel
                                                    </button>
                                                </div>
                                            </div>
                                        )}
                                    ...
                                    {selected.injectionsTherapies.map((v, i) => (
                                        <div className={styles.selRow} key={`inj-${i}`}>
                                            {editIdx.inj === i ? (
                                                <>
                                                    <input className={styles.inlineInput} value={editBuf}
                                                           onChange={(e) => setEditBuf(e.target.value)}/>
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.saveBtn}
                                                                onClick={() => saveInlineEdit("inj")}>Save
                                                        </button>
                                                        <button className={styles.cancelBtn}
                                                                onClick={() => cancelInline("inj")}>Cancel
                                                        </button>
                                                    </div>
                                                </>
                                            ) : (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.editBtn}
                                                                onClick={() => startInlineEdit("inj", i, v)}>Edit
                                                        </button>
                                                        <button className={styles.removeBtn}
                                                                onClick={() => removeFromArray("injectionsTherapies", i)}>✕
                                                        </button>
                                                    </div>
                                                </>
                                            )}
                                ...
                                <div className={styles.selectedSection}>
                                    <div className={styles.sectionHeader}>
                                        ...
                                        {!showAdd.non ? (
                                            <button className={styles.addBtn} onClick={() => openAdd("non")}>+
                                                Add</button>
                                        ) : (
                                            <div className={styles.addInlineWrap}>
                                                <input
                                                ...
                                                <div className={styles.rowActions}>
                                                    <button className={styles.saveBtn}
                                                            onClick={() => saveAdd("non")}>Save
                                                    </button>
                                                    <button className={styles.cancelBtn}
                                                            onClick={() => cancelAdd("non")}>Cancel
                                                    </button>
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        <div className={styles.selRow} key={`non-${i}`}>
                                            {editIdx.non === i ? (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.saveBtn}
                                                                onClick={() => saveInlineEdit("non")}>Save
                                                        </button>
                                                        <button className={styles.cancelBtn}
                                                                onClick={() => cancelInline("non")}>Cancel
                                                        </button>
                                                    </div>
                                                </>
                                            ) : (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.editBtn}
                                                                onClick={() => startInlineEdit("non", i, v)}>Edit
                                                        </button>
                                                        <button className={styles.removeBtn}
                                                                onClick={() => removeFromArray("nonDrugRecommendations", i)}>✕
                                                        </button>
                                                    </div>
                                                </>
                                            )}
                                ...
                                <div className={styles.selectedSection}>
                                    <div className={styles.sectionHeader}>
                                        ...
                                        {!showAdd.life ? (
                                            <button className={styles.addBtn} onClick={() => openAdd("life")}>+
                                                Add</button>
                                        ) : (
                                            <div className={styles.addInlineWrap}>
                                                <input
                                                ...
                                                <div className={styles.rowActions}>
                                                    <button className={styles.saveBtn}
                                                            onClick={() => saveAdd("life")}>Save
                                                    </button>
                                                    <button className={styles.cancelBtn}
                                                            onClick={() => cancelAdd("life")}>Cancel
                                                    </button>
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        <div className={styles.selRow} key={`life-${i}`}>
                                            {editIdx.life === i ? (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.saveBtn}
                                                                onClick={() => saveInlineEdit("life")}>Save
                                                        </button>
                                                        <button className={styles.cancelBtn}
                                                                onClick={() => cancelInline("life")}>Cancel
                                                        </button>
                                                    </div>
                                                </>
                                            ) : (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.editBtn}
                                                                onClick={() => startInlineEdit("life", i, v)}>Edit
                                                        </button>
                                                        <button className={styles.removeBtn}
                                ...
                                <div className={styles.selectedSection}>
                                    <div className={styles.sectionHeader}>
                                        ...
                                        {!showAdd.fu ? (
                                            <button className={styles.addBtn} onClick={() => openAdd("fu")}>+
                                                Add</button>
                                        ) : (
                                            <div className={styles.addInlineWrap}>
                                                <input
                                                ...
                                                <div className={styles.rowActions}>
                                                    <button className={styles.saveBtn}
                                                            onClick={() => saveAdd("fu")}>Save
                                                    </button>
                                                    <button className={styles.cancelBtn}
                                                            onClick={() => cancelAdd("fu")}>Cancel
                                                    </button>
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        <div className={styles.selRow} key={`fu-${i}`}>
                                            {editIdx.fu === i ? (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.saveBtn}
                                                                onClick={() => saveInlineEdit("fu")}>Save
                                                        </button>
                                                        <button className={styles.cancelBtn}
                                                                onClick={() => cancelInline("fu")}>Cancel
                                                        </button>
                                                    </div>
                                                </>
                                            ) : (
                                                <>
                                                    ...
                                                    <div className={styles.rowActions}>
                                                        <button className={styles.editBtn}
                                                                onClick={() => startInlineEdit("fu", i, v)}>Edit
                                                        </button>
                                                        <button className={styles.removeBtn}
                                                                onClick={() => removeFromArray("followUpInstructions", i)}>✕
                                                        </button>
                                                    </div>
                                                </>
                                            )}
                                ...
                                <div className={styles.row13}>
                                    ...
                                    <button className={styles.approve} onClick={() => onConfirm(selected)}
                                    ...
                                    <form onSubmit={submitMedModal} className={styles.modalBody}>
                                        ...
                                        <div className={styles.modalFooter}>
                                            <button type="button" className={styles.cancelBtn}
                                                    onClick={closeMedModal}>Cancel
                                            </button>
                                            <button type="submit"
                                                    className={styles.saveBtn}>{medModalMode === "add" ? "Add" : "Save"}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
