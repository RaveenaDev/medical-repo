...
const TreatmentAndTestPrint = forwardRef(({ treatments, tests }, ref) => {
  return (
    <div ref={ref} className={`${styles.printLayout} ${styles.printOnly}`}>
      ...
      <section className={styles.patientInfo}>
        <div>
          <p>
            <strong>Patient Name:</strong> __________________
          </p>
          <p>
            <strong>Age / Gender:</strong> ______ / ______
          </p>
        </div>
        <div>
          <p>
          ...
          <p>
            <strong>ID / OPD No:</strong> ____________
          </p>
        </div>
      </section>
      ...
      <footer className={styles.footer}>
        ...
        <p className={styles.note}>
          ⚕ Please follow dosage instructions carefully and consult if symptoms
          persist.
        </p>
      </footer>
    </div>
