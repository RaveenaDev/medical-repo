...
const Complete = ({ onClose,onComplete }) => {
        ...
        <p style={{fontSize:'1.16rem'}}>Prescription Delivery</p>
          ...
          <div style={{display:'flex',flexDirection:'column'}}>
              ...
              ,alignItems:'center',padding:'1rem 1.5rem'
                  ...
                  <div style={{gap:'1rem',padding:'8px 0',cursor:'pointer',backgroundColor:'#F2F5FF',width:'100%',display:'flex',justifyContent:'center'}}>
          ...
          <div>
              <button onClick={handleComplete} style={{width:'fit-content',padding:"8px 1.2rem"}}>Confirm and Proceed</button>
              <button onClick={onClose} style={{width:'fit-content',padding:"4px 1rem",backgroundColor:'#ffffff',border:'1px solid #25307f',color:"#292929",
