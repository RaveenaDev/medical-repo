          ...
          <div className="visit-details">
            ...
            <div className="kv-table">
              ...
              <div className="kv-row">
                ...
                <div className="kv-val">{item?.typeofVisit || "Consultation"}</div>
              </div>
              {c?.status && (
                  <div className="kv-row">
              ...
              {c?.followUpRequired !== undefined && (
                  <div className="kv-row">
                    ...
                    <div className="kv-val">{c.followUpRequired ? "Yes" : "No"}</div>
                  </div>
              )}
              {c?.treatment?.note && (
                  <div className="kv-row">
        ...
        <div className="phases-stack">
          {sorted.map((p, idx) => (
              <div className="phase-card" key={p?._id || idx}>
                ...
                <JSONValue value={Array.isArray(p?.consultation) ? p.consultation : []} />
          ...
          <div className="visit-details">
            ...
            <div className="kv-table">
              ...
              <div className="kv-row">
                ...
                <div className="kv-val">{a?.approval?.doctor?.name || "Pending"}</div>
              </div>
              <div className="kv-row">
                <div className="kv-key">Admin Approval</div>
                <div className="kv-val">{a?.approval?.admin?.name || "Pending"}</div>
              </div>
            </div>
