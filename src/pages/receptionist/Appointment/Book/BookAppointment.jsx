...
import {TextField, MenuItem, Button, Divider, Modal, Box, Typography} from "@mui/material";
...
const BookAppointment = ({ isOpen, onClose, isFromDoctor, doctorName }) => {
  ...
  const bookingSuccess = useSelector((store) => store.receptionist.bookAppointment)
  ...
  return (
      <>
            ...
            >
              <Box sx={style}>
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"28px"}}>
                  ...
                  <Button
                      onClick={onClose}
                      sx={{backgroundColor: "#25307F", color: 'white',"&:focus": {
                      outline: "none",
                      boxShadow: "none",
                    },}}>
        ...
        <div
            ...
            //   opacity: showSuccessModal ? 0.5 : 1,
