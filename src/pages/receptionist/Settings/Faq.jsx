...
const Faq = () => {
  return (
    <div>
      <Container
        maxWidth="md"
        sx={{ color: "#838383", padding: 0, marginTop: "3rem" }}
      >
        <Typography
          variant="h6"
          sx={{
        ...
        <Accordion>
          ...
          <AccordionDetails sx={{ color: "#747474" }}>
            To schedule a new appointment, click on the ‘New Appointment’
            button, select the patient, type of consultation, doctor, and
            confirm the time.
          </AccordionDetails>
        </Accordion>
        <Accordion>
        ...
        <Accordion>
          ...
          >
            How can I check a doctor's availability for a specific date and
            time?
          </AccordionSummary>
          <AccordionDetails sx={{ color: "#747474" }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
