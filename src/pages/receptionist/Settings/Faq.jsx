...
const Faq = () => {
    return (
        <>
            <div style={{display:'flex',position:'absolute',right:'2rem',top:'1.2rem'}}>
                <Searchbar/>
                <Notifications/>
            </div>
            ...
            <Box sx={{width: "100%", padding: "1rem 1rem",marginTop:'2.5rem'}}>
                ...
                {[
                    ...
                    {
                        question: "How can I access the system's help or support resources?",
                        answer:
                    ...
                    {
                        question: "What should I do if there is a discrepancy in a patient's payment?",
                        answer:
                            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget.",
                    },
                ].map((item, index) => (
                    <Accordion
                        key={index}
                        sx={{ marginBottom: "0.5rem", width: "96%",
                            boxShadow: "none",
                            border: "none",
                            '&::before': {
                    ...
                    >
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon sx={{ color: "#25307F",fontSize:'1.7rem' }} />}
