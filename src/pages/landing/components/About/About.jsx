    ...
    <div className="about-container" id="about">
      <div className="about-text">
        ...
        <div className="about-heading">
          Next-Gen HMS Software That Redefines
          <span className="highlight"> Healthcare Efficiency</span>
        </div>
      ...
      <div className="about-why-us" data-aos="zoom-in-left">
        <ul className="why-us-list">
          <li className="why-us-item">
            ...
            <p className="why-us-text">
              Built for Hospitals, Clinics & Multispecialty Centers
            </p>
          </li>
          ...
          <li className="why-us-item">
            ...
            <p className="why-us-text">Deploy on Cloud or On-Premise</p>
          </li>
          ...
          <li className="why-us-item">
            ...
            <p className="why-us-text">
              Customizable Modules & Role-Based Access
            </p>
          </li>
          <li className="why-us-item">
            <p className="why-us-icon">
