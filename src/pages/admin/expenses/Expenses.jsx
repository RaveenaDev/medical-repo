        ...
        <>
            ...
            <Box sx={{display: "flex", gap: 1, mt: 2}}>
                <div style={{display: "flex", flexDirection: "column", width: '12rem'}}>
                    ...
                    <FormControl sx={{my: 1}}>
                        <InputLabel id="demo-simple-select-helper-label">Salaries</InputLabel>
                        <Select
                ...
                <div style={{display: "flex", flexDirection: "column", width: '12rem', gap: "7px"}}>
                    <div style={{paddingLeft: "0.2rem"}}>
                ...
                <TableContainer component={Paper}>
                    <Table sx={{
                        ...
                        <TableHead>
                            <TableRow>
                                <TableCell
                                    sx={{fontSize: '15px', color: '#959595', padding: '8px 14px', border: 'none'}}>
                                    Expense Type
                                </TableCell>
                        ...
                        <TableBody>
                            {rows.map((row) => (
                                <TableRow
                                    key={row.name}
                                    sx={{
                                        '&:last-child td, &:last-child th': {border: 0}, backgroundColor: '#F1F5FF'
                                    }}
                                >
                                    ...
                                    <TableCell align="center"
                                               sx={{border: 'none'}}>{truncateText(row.appointmentWith, 14)}</TableCell>
