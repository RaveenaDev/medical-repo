          ...
          <div className=" toAdmitSliderWrapper">
            {filteredAdmissions.length === 0 ? (
              <EmptyState
                ...
                description="There are no pending or approved admission requests at the moment."
              />
            ) : (
          ...
          <div className="admittedList">
            {currentPatients.length > 0 ? (
              ...
              <EmptyState
                ...
                description={`No patients match the "${filter}" filter.`}
                actionText="Add Patient"
                onAction={handleAddPatientClick}
              />
            )}
          </div>
        )}
