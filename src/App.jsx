    ...
    <>
        <div className={`${isSignUpOrLogin ? "" : styles.crmApp}`}>
          ...
          <div className={`${styles.register} ${isSignUpOrLogin ? styles.loginPageActive : styles.otherPages}`}>
            ...
            <Route path="/admin/reception/patients/History" element={ <History setIsSignUpOrLogin={setIsSignUpOrLogin} setEntity={setEntity} entity={entity}/> }></Route>
            <Route path="/admin/reception/patients/Tracking" element={ <Tracking setIsSignUpOrLogin={setIsSignUpOrLogin} setEntity={setEntity} entity={entity}/> }></Route>
